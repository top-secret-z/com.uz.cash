<section class="section">
	<header class="sectionHeader">
		<h2 class="sectionTitle">{lang}cash.credit.user.data{/lang}</h2>
	</header>
	
	<dl>
		<dt><label for="amount">{lang}cash.credit.user.amount{/lang}</label></dt>
		<dd>
	...
	<dl>
		<dt><label for="currency">{lang}cash.credit.user.currency{/lang}</label></dt>
		<dd>
	...
	<dl>
		<dt><label for="subject">{lang}cash.credit.user.subject{/lang}</label></dt>
		<dd>
