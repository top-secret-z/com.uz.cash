...
class UserCashClaimAction extends AbstractDatabaseObjectAction {
	...
	public function getClaimEditDialog () {
		...
		if (empty($this->userClaim->subject)) $subject = $this->claim->subject;
		else $subject = $this->userClaim->subject;
	...
	public function getClaimPayDialog () {
		...
		foreach ($objectTypes as $objectType) {
			if (in_array($objectType->objectType, $excludedPaymentMethods)) continue;
		...
		foreach ($paymentMethods as $paymentMethod) {
			if (!in_array($this->userClaim->currency, $paymentMethod->getSupportedCurrencies())) continue;
