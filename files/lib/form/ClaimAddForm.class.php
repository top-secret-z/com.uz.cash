...
class ClaimAddForm extends MessageForm {
	...
	public function readFormParameters() {
		...
		if (isset($_POST['excludedPaymentMethods'])) $this->excludedPaymentMethods = array_keys(ArrayUtil::trim($_POST['excludedPaymentMethods']));
	...
	public function readData() {
		...
		foreach ($objectTypes as $objectType) {
			if (in_array($objectType->objectType, $temp)) $this->availablePaymentMethods[$objectType->objectType] = WCF::getLanguage()->get('wcf.payment.'.$objectType->objectType);
		}
