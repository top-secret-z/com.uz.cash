...
define(["require", "exports", "tslib", "WoltLabSuite/Core/Ajax", "WoltLabSuite/Core/Language", "WoltLabSuite/Core/Ui/Notification", "WoltLabSuite/Core/Ui/Confirmation"], function (require, exports, tslib_1, Ajax, Language, UiNotification, UiConfirmation) {
    ...
    class UZCashUserClaimBalance {
        constructor() {
            var buttons = document.querySelectorAll('.jsBalanceButton');
        ...
        _click(event) {
            ...
            UiConfirmation.show({
                ...
                message: Language.get('cash.claim.user.balance.confirm')
            });
        }
    }

    let uZCashUserClaimBalance;
    function init() {
        if (!uZCashUserClaimBalance) {
            uZCashUserClaimBalance = new UZCashUserClaimBalance();
        }
    }
    exports.init = init;
});
