...
define(["require", "exports", "tslib", "WoltLabSuite/Core/Ajax", "WoltLabSuite/Core/Language", "WoltLabSuite/Core/Ui/Notification", "WoltLabSuite/Core/Ui/Confirmation"], function (require, exports, tslib_1, Ajax, Language, UiNotification, UiConfirmation) {
	...
	class UZCashUserCreditUncredit {
		constructor() {
			var buttons = document.querySelectorAll('.jsUncreditButton');
		...
		_click(event) {
			...
			UiConfirmation.show({
				...
				message: Language.get('cash.credit.user.uncredit.confirm')
			});
		}
	}
	
	let uZCashUserCreditUncredit;
	function init() {
		if (!uZCashUserCreditUncredit) {
			uZCashUserCreditUncredit = new UZCashUserCreditUncredit();
		}
	}
	exports.init = init;
});
